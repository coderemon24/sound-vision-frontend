                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li  class="dropdown current"><a href="photo-gallery.php#">Events</a>
                                    <ul>
        ...
        <div class="mobile-menu">
            ...
            <div class="nav-bottom">
                ...
                <div class="social-links">
                    <ul class="clearfix">
                        <li><a href="photo-gallery.php#"><span class="fab fa-facebook-f"></span></a></li>
                        <li><a href="photo-gallery.php#"><span class="fab fa-twitter"></span></a></li>
                        <li><a href="photo-gallery.php#"><span class="fab fa-vimeo-v"></span></a></li>
                    </ul>
                </div>
            </div>
        </div><!-- End Mobile Menu -->
            ...
            <div class="sortable-masonry filter-gallery">
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        <li class="filter active" data-role="button" data-filter=".all">All</li>
                         ...
                         <li class="filter" data-role="button" data-filter=".class24">Outdoor</li><li class="filter" data-role="button" data-filter=".class28">events</li><li class="filter" data-role="button" data-filter=".class29">indoor</li><li class="filter" data-role="button" data-filter=".class31">interview</li>                        
                ...
                <div class="items-container row clearfix">
                    <!--Item-->
                       ...
                       <div class="gallery-item masonry-item all class24   col-lg-3 col-md-6 col-sm-12">
                        <div class="gallery-block">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="admin/public/crop_image/1646205789.png" alt="" title="">
                                </div>
                                <a href="admin/public/crop_image/1646205789.png" class="overlink lightbox-image" data-fancybox="gallery-1"><span class="icon flaticon-cross"></span></a>
                            </div>
                        </div>
                    </div> <div class="gallery-item masonry-item all class24   col-lg-3 col-md-6 col-sm-12">
                        <div class="gallery-block">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="admin/public/crop_image/1646308490.png" alt="" title="">
                                </div>
                                <a href="admin/public/crop_image/1646308490.png" class="overlink lightbox-image" data-fancybox="gallery-1"><span class="icon flaticon-cross"></span></a>
                            </div>
                        </div>
                    </div> <div class="gallery-item masonry-item all class28   col-lg-3 col-md-6 col-sm-12">
                        <div class="gallery-block">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="admin/public/crop_image/1646308833.png" alt="" title="">
                                </div>
                                <a href="admin/public/crop_image/1646308833.png" class="overlink lightbox-image" data-fancybox="gallery-1"><span class="icon flaticon-cross"></span></a>
                            </div>
                        </div>
                    </div> <div class="gallery-item masonry-item all class24   col-lg-3 col-md-6 col-sm-12">
                        <div class="gallery-block">
                            <div class="inner-box">
                                <div class="image">
                                    <img src="admin/public/crop_image/1646308855.png" alt="" title="">
                                </div>
                                <a href="admin/public/crop_image/1646308855.png" class="overlink lightbox-image" data-fancybox="gallery-1"><span class="icon flaticon-cross"></span></a>
                            </div>
                        </div>
                    </div>                    
                    ...
                    <!--Item-->
                    <!--<div class="gallery-item masonry-item all special luxury family fitness activity col-lg-3 col-md-6 col-sm-12">-->
                    <!--    <div class="gallery-block">-->
                    <!--        <div class="inner-box">-->
                    <!--            <div class="image">-->
